    ...
    services: [
      {
        ...
        layers: [
          { id: '10', label: 'Hittestress - Kwetsbaarheid objecten' },
          { id: '26', label: 'Hittestress - Kwetsbare gezinnen en hitte' },
          { id: '27', label: 'Hittestress - Kwetsbare gezinnen en verharding' },
          { id: '11', label: 'Hittestress - Opwarming drinkwater Dunea' },
          { id: '28', label: 'Hittestress - Ouderen en hitte' },
          { id: '29', label: 'Hittestress - Ouderen en verharding' },
          { id: '31', label: 'Hittestress - Somatische aandoening en hitte' },
          { id: '30', label: 'Hittestress - Somatische aandoening en verharding' },
          { id: '32', label: 'Hittestress - Verstandelijke beperking en hitte' },
          { id: '33', label: 'Hittestress - Verstandelijke beperking en verharding' },
          { id: '3',  label: 'Bodemdaling - Bodemdaling kunstwerken' },
          { id: '4',  label: 'Bodemdaling - Bodemdaling vaarwegen' },
          { id: '5',  label: 'Bodemdaling - Bodemdaling wegen' },
          { id: '6',  label: 'Bodemdaling - Kwetsbaarheid panden' },
          { id: '12', label: 'Overstromingen - Begaanbaarheid boezemkadebreuk' },
          { id: '13', label: 'Overstromingen - Droge verdiepingen na dijkdoorbraak' },
          { id: '14', label: 'Overstromingen - Kwetsbaarheid panden na dijkdoorbraak' },
          { id: '15', label: 'Overstromingen - Kwetsbaarheid panden na dijkdoorbraak (2)' },
          { id: '17', label: 'Wateroverlast - Begaanbaarheid hoosbui prov. wegen' },
          { id: '18', label: 'Wateroverlast - Begaanbaarheid wegen landelijk gebied' },
          { id: '19', label: 'Wateroverlast - Begaanbaarheid wegen stedelijk gebied' },
          { id: '20', label: 'Wateroverlast - Gehinderd verkeer provinciale wegen' },
          { id: '21', label: 'Wateroverlast - Hinder scheepvaartverkeer vaarwegen' },
          { id: '22', label: 'Wateroverlast - Kwetsbaarheid objecten extreme neerslag' },
          { id: '23', label: 'Wateroverlast - Kwetsbaarheid panden extreme neerslag' },
          { id: '24', label: 'Wateroverlast - Modelcontrole extreme neerslag landelijk' },
          { id: '34', label: 'Wateroverlast - Vaarwegklasse provinciale vaarwegen' },
          { id: '35', label: 'Wateroverlast - Peilstijging provinciale vaarwegen' },
          { id: '36', label: 'Wateroverlast - Modelinformatie neerslag stedelijk gebied' },
        ]
      },
      {
        id: 'klimaat_buffers',
